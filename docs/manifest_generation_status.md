...
```bash
ln -s /scratch/aaa_exchange/AWARE/CLEAR_DAY_TRAIN/Cityscapes \
      /scratch/aaa_exchange/AWARE/FINAL_SPLITS/train/images/Cityscapes
```
...
The following directories have manifest.json files owned by `mima2416` with 600 permissions, preventing updates:

| Directory | Structure | Manifest Owner | Permission |
|-----------|-----------|----------------|------------|
| albumentations_weather | dataset_domain | mima2416 | 600 |
| Attribute_Hallucination | unknown | mima2416 | 600 |
| augmenters | flat_dataset | mima2416 | 600 |
| automold | flat_dataset | mima2416 | 600 |
| CNetSeg | flat_dataset | mima2416 | 600 |
| CUT | domain_dataset | mima2416 | 600 |
| cyclediffusion | dataset_domain | mima2416 | 600 |
| EDICT | flat_domain | mima2416 | 600 |
| flux2 | domain_dataset | mima2416 | 644 |
| flux_kontext | dataset_domain | mima2416 | 600 |
| LANIT | flat_domain | mima2416 | 600 |
| magicbrush | dataset_domain | mima2416 | 600 |
| Qwen-Image-Edit | dataset_domain | mima2416 | 600 |
| stargan_v2 | unknown | mima2416 | 600 |
| step1x_new | dataset_domain | mima2416 | 600 |
| step1x_v1p2 | dataset_domain | mima2416 | 600 |
| StyleID | domain_dataset | mima2416 | 600 |
| SUSTechGAN | dataset_domain | mima2416 | 600 |
| TSIT | flat_dataset | mima2416 | 600 |
| VisualCloze | dataset_domain | mima2416 | 644 |
| visualcloze | dataset_domain | mima2416 | 600 |
| Weather_Effect_Generator | flat_dataset | mima2416 | 600 |
...
Have `mima2416` run:
```bash
chmod 666 /scratch/aaa_exchange/AWARE/GENERATED_IMAGES/*/manifest.json
```

### Option 2: Delete and Regenerate
For directories owned by chge7185, remove existing manifest.json and regenerate:
```bash
rm /scratch/aaa_exchange/AWARE/GENERATED_IMAGES/*/manifest.json
python tools/generate_manifests.py --all
```

### Option 3: Run as mima2416
Have `mima2416` run the regeneration:
```bash
...
```
/scratch/aaa_exchange/AWARE/GENERATED_IMAGES/
