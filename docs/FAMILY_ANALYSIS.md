...
| Directory | Content |
|-----------|---------|
| `/scratch/aaa_exchange/AWARE/WEIGHTS/` | Single strategy results (25 strategies) |
| `/scratch/aaa_exchange/AWARE/WEIGHTS_COMBINATIONS/` | Combined strategy results (13 combinations) |
| `/scratch/aaa_exchange/AWARE/WEIGHTS_EXTENDED/` | Extended training results |
| `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/` | Ratio ablation results |
