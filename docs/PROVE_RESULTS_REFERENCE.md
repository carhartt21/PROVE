...
### External Root Path
All data lives under: `/scratch/aaa_exchange/AWARE/`
...
**File:** `/scratch/aaa_exchange/AWARE/FINAL_SPLITS/split_statistics.json`
...
- **File:** `/scratch/aaa_exchange/AWARE/CITYSCAPES/`
...
**All manifests summary:** `/scratch/aaa_exchange/AWARE/GENERATED_IMAGES/all_manifests_summary.json`
...
**Location:** `/scratch/aaa_exchange/AWARE/STATS/{method}/`
...
**Location:** `/scratch/aaa_exchange/AWARE/STATS/`
...
| Property | Value |
|----------|-------|
| **Location** | `/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES_RATIO/` |
...
9. `/scratch/aaa_exchange/AWARE/FINAL_SPLITS/split_statistics.json` — Dataset split info
10. `/scratch/aaa_exchange/AWARE/GENERATED_IMAGES/all_manifests_summary.json` — Generation summary
11. `generated_manifests/*.json` — Per-strategy manifests (24 files)

#### Optional (per-strategy quality stats):
12. `/scratch/aaa_exchange/AWARE/STATS/{method}/{domain}_stats.json` — Per-method quality metrics
