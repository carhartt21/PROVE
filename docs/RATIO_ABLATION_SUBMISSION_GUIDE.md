...
```
/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/{strategy}/{dataset}/{model}_ratio{XX}p{YY}/
```

Examples:
- `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/gen_stargan_v2/bdd10k/pspnet_r50_ratio0p00/`
- `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/gen_stargan_v2/bdd10k/pspnet_r50_ratio0p25/`
- `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/gen_cycleGAN/iddaw/pspnet_r50_ratio0p50/`
...
ls -lh /scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/gen_stargan_v2/bdd10k/*/iter_10000.pth
```
...
This will create:
- `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/gen_stargan_v2/bdd10k/pspnet_r50_ratio0p00/` ✅ New (fixed)
- `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/gen_stargan_v2/iddaw/pspnet_r50_ratio0p00/` ✅ New (fixed)
- etc.
