...
|-------|-------|-------------|--------|
| **Ratio Ablation** | Real/Gen ratio | Compare 0.125, 0.25, 0.375. 0.5, 0.625, 0.75, 0,875, 1.0 ratios | 🔄 In Progress (8 jobs) |
...
|----------|-------|----------|---------|---------|--------|
| **Generative (gen_*)** | 83 | 83 | 0 | 0 | 1 |
| **Standard (std_*)** | 28 | 28 | 0 | 0 | 0 |
| **TOTAL** | 111 | 111 | 0 | 0 | 1 |
