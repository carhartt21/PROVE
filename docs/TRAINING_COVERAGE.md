...
| ⚠️ Missing (not started) | 336 | 100.0% |
| ❌ Failed | 0 | 0.0% |
| **Total** | **336** | **100%** |
...
| gen_flux_kontext | mapillaryvistas | SegFormer (0.5) |
...
| gen_step1x_new | mapillaryvistas | SegFormer (0.5) |
...
| gen_step1x_v1p2 | bdd10k | SegFormer (0.5) |
| gen_step1x_v1p2 | idd-aw | DeepLabV3+ (0.5) |
| gen_step1x_v1p2 | idd-aw | PSPNet (0.5) |
| gen_step1x_v1p2 | idd-aw | SegFormer (0.5) |
...
| photometric_distort | outside15k | DeepLabV3+ |
| photometric_distort | outside15k | PSPNet |
...
| std_autoaugment | idd-aw | PSPNet |
| std_autoaugment | idd-aw | SegFormer |
...
| std_cutmix | bdd10k | PSPNet |
| std_cutmix | bdd10k | SegFormer |
| std_cutmix | idd-aw | DeepLabV3+ |
| std_cutmix | idd-aw | PSPNet |
| std_cutmix | idd-aw | SegFormer |
| std_cutmix | mapillaryvistas | DeepLabV3+ |
| std_cutmix | mapillaryvistas | PSPNet |
| std_cutmix | mapillaryvistas | SegFormer |
...
| std_mixup | bdd10k | PSPNet |
| std_mixup | bdd10k | SegFormer |
| std_mixup | idd-aw | DeepLabV3+ |
| std_mixup | idd-aw | PSPNet |
| std_mixup | idd-aw | SegFormer |
| std_mixup | mapillaryvistas | DeepLabV3+ |
| std_mixup | mapillaryvistas | PSPNet |
| std_mixup | mapillaryvistas | SegFormer |
...
| std_randaugment | mapillaryvistas | SegFormer |
