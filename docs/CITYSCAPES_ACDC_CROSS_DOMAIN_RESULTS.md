...
- **Model Weights:** `/scratch/aaa_exchange/AWARE/CITYSCAPES_REPLICATION/`
- **Test Results:** `/scratch/aaa_exchange/AWARE/CITYSCAPES_REPLICATION/acdc_cross_domain_results/`
