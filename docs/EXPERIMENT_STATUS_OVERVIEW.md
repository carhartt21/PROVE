...
### Status
- Directory created: `/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES/`
...
| Type | Path |
|------|------|
| Stage 1 Weights | `/scratch/aaa_exchange/AWARE/WEIGHTS/` |
| Stage 2 Weights | `/scratch/aaa_exchange/AWARE/WEIGHTS_STAGE_2/` |
| **Loss Ablation** | `/scratch/aaa_exchange/AWARE/WEIGHTS_LOSS_ABLATION/` |
| Cityscapes | `/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES/` |
| Ratio Ablation | `/scratch/aaa_exchange/AWARE/WEIGHTS_RATIO_ABLATION/` |
| Extended Training | `/scratch/aaa_exchange/AWARE/WEIGHTS_EXTENDED/` |
