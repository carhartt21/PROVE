...
def find_sample_label():
    ...
    paths = [
        Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/labels/MapillaryVistas/clear_day"),
        Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/val/labels/MapillaryVistas/clear_day"),
    ]
    for p in paths:
        if p.exists():
...
def main():
    ...
    if label_path is None:
        ...
        print("Paths checked:")
        print("  /scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/labels/MapillaryVistas/clear_day")
        print("  /scratch/aaa_exchange/AWARE/FINAL_SPLITS/val/labels/MapillaryVistas/clear_day")
        sys.exit(1)
