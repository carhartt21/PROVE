...
def load_bdd10k_files():
    ...
    bdd10k_path = "/scratch/aaa_exchange/AWARE/FINAL_SPLITS/train/images/BDD10k"
    ...
    for root, dirs, files in os.walk(bdd10k_path):
        for f in files:
            if f.endswith(('.jpg', '.png', '.jpeg')):
                ...
                rel_path = full_path.replace('/scratch/aaa_exchange/AWARE/FINAL_SPLITS/', '')
                bdd10k_files[f] = '/scratch/aaa_exchange/AWARE/FINAL_SPLITS/' + rel_path
...
def main():
    ...
    gen_images_root = "/scratch/aaa_exchange/AWARE/GENERATED_IMAGES"
