...
def load_bdd10k_label():
    ...
    label_path = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/labels/BDD10k/clear_day")
...
def load_mapillary_label():
    ...
    label_path = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/labels/MapillaryVistas/clear_day")
    labels = list(label_path.glob("*.png"))
    if labels:
        return cv2.imread(str(labels[0]), cv2.IMREAD_UNCHANGED)
    return None
...
def profile_io_operations():
    ...
    # BDD10k
    bdd_img_path = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/images/BDD10k/clear_day")
    bdd_label_path = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/labels/BDD10k/clear_day")
    
    # MapillaryVistas
    mv_img_path = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/images/MapillaryVistas/clear_day")
    mv_label_path = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/test/labels/MapillaryVistas/clear_day")
