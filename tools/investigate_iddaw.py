...
def main():
    ...
    base = '/scratch/aaa_exchange/AWARE/FINAL_SPLITS'
    ...
    config_path = '/scratch/aaa_exchange/AWARE/WEIGHTS/baseline/idd-aw_cd/deeplabv3plus_r50/configs/training_config.py'
