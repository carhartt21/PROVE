...
**Path**: `/scratch/aaa_exchange/AWARE/WEIGHTS/baseline/bdd10k/deeplabv3plus_r50/configs/training_config.py`
...
**Path**: `/scratch/aaa_exchange/AWARE/WEIGHTS/gen_cycleGAN/bdd10k/deeplabv3plus_r50_ratio0p50/configs/training_config.py`

```python
generated_augmentation = {
    'enabled': True,
    'generative_model': 'cycleGAN',
    'manifest_path': '/scratch/aaa_exchange/AWARE/GENERATED_IMAGES/cycleGAN/manifest.csv',
    'gen_root': '/scratch/aaa_exchange/AWARE/GENERATED_IMAGES/cycleGAN',
    'real_gen_ratio': 0.5
}
...
mixed_dataloader = {
    ...
    'generated_dataset': {
        ...
        'generated_root': '/scratch/aaa_exchange/AWARE/GENERATED_IMAGES/cycleGAN',
