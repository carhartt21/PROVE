...
FINAL_SPLITS_DIR = Path("/scratch/aaa_exchange/AWARE/FINAL_SPLITS/train/images")
CITYSCAPES_ORIGINALS_DIR = Path("/scratch/aaa_exchange/AWARE/CITYSCAPES/leftImg8bit/train")
