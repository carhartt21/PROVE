...
#BSUB -o /scratch/aaa_exchange/AWARE/CITYSCAPES_REPLICATION/{model_name}/lsf_%J.out
#BSUB -e /scratch/aaa_exchange/AWARE/CITYSCAPES_REPLICATION/{model_name}/lsf_%J.err
#BSUB -q BatchGPU
#BSUB -n 8
#BSUB -R "span[hosts=1]"
...
cd /home/mima2416/repositories/mmsegmentation

# Create output directory
mkdir -p /scratch/aaa_exchange/AWARE/CITYSCAPES_REPLICATION/{model_name}
...
python -m torch.distributed.launch \\
    ...
    tools/train.py \\
    {config} \\
    --work-dir /scratch/aaa_exchange/AWARE/CITYSCAPES_REPLICATION/{model_name} \\
    --launcher pytorch \\
    --cfg-options \\
        data_root=/scratch/aaa_exchange/AWARE/CITYSCAPES_DATA
...
def main():
    ...
    parser.add_argument('--output-dir', type=Path,
                       default=Path('/home/mima2416/repositories/PROVE/cityscapes_replication/jobs'),
