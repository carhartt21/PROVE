...
#BSUB -o ${HOME}/repositories/PROVE/logs/combinations_batchgpu_fixed/train_gen_step1x_new_std_mixup_iddaw_pspnet_r50_ratio0p5_%J.out
#BSUB -e ${HOME}/repositories/PROVE/logs/combinations_batchgpu_fixed/train_gen_step1x_new_std_mixup_iddaw_pspnet_r50_ratio0p5_%J.err
#BSUB -q BatchGPU
#BSUB -n 8
