...
#BSUB -o /home/mima2416/repositories/PROVE/logs/combinations_batchgpu/train_gen_step1x_new_photometric_distort_bdd10k_segformer_mit-b5_ratio0p5_%J.out
#BSUB -e /home/mima2416/repositories/PROVE/logs/combinations_batchgpu/train_gen_step1x_new_photometric_distort_bdd10k_segformer_mit-b5_ratio0p5_%J.err
#BSUB -q BatchGPU
#BSUB -n 8
