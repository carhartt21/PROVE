...
#BSUB -o /home/mima2416/repositories/PROVE/logs/ext_baseline_bdd10k_segformer_%J.out
#BSUB -e /home/mima2416/repositories/PROVE/logs/ext_baseline_bdd10k_segformer_%J.err
#BSUB -q BatchGPU
#BSUB -W 48:00
#BSUB -n 4
...
STRATEGY="baseline"
OUTPUT_DIR="/scratch/aaa_exchange/AWARE/WEIGHTS_EXTENDED/baseline/bdd10k/segformer_mit-b5"
RESUME_CKPT="/scratch/aaa_exchange/AWARE/WEIGHTS_STAGE_2/baseline/bdd10k/segformer_mit-b5/iter_80000.pth"
MAX_ITERS=320000
