#!/bin/bash
# Multi-Model Training Script for BDD100k Dataset
...
echo "BDD100k Multi-Model Training Script"
echo "=================================="
...
configs="faster_rcnn_r50_fpn_1x yolox_l rtmdet_l"
...
echo
echo "Training summary for BDD100k:"
