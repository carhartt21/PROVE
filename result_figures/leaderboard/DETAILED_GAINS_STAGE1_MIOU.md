...
| gen_VisualCloze | Generative | 45.7 | +3.5 | - | - | 32.9 | +6.3 | 40.5 | +7.6 | +5.79 |
...
| gen_flux_kontext | Generative | 44.5 | +2.3 | - | - | 33.0 | +6.3 | 40.9 | +8.0 | +5.53 |
| gen_SUSTechGAN | Generative | 44.8 | +2.6 | - | - | 32.8 | +6.1 | 40.4 | +7.6 | +5.42 |
| gen_step1x_new | Generative | 44.7 | +2.4 | - | - | 32.9 | +6.3 | 40.4 | +7.6 | +5.43 |
| gen_TSIT | Generative | 46.6 | +4.3 | - | - | 30.1 | +3.4 | 40.7 | +7.8 | +5.18 |
| gen_automold | Generative | 46.1 | +3.8 | - | - | 32.9 | +6.3 | 40.6 | +7.7 | +5.92 |
| gen_LANIT | Generative | 44.6 | +2.3 | - | - | 32.9 | +6.2 | 40.7 | +7.8 | +5.44 |
