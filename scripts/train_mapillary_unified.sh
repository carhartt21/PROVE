#!/bin/bash
# PROVE Training Script: Mapillary Vistas Dataset (Unified label space)
# Dataset: /scratch/aaa_exchange/AWARE/FINAL_SPLITS/train/mapillary_vistas

set -e

# Configuration
CONFIG="configs/mapillary_vistas_unified_config.py"
WORK_DIR="/scratch/aaa_exchange/AWARE/WEIGHTS/mapillary_deeplabv3plus_r50_unified"
...
echo "============================================"
echo "PROVE Training: Mapillary Vistas (Unified)"
echo "============================================"
echo "Config: ${CONFIG}"
