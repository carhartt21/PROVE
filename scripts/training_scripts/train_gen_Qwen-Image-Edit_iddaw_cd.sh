#!/bin/bash
#BSUB -J train_gen_Qwen-Image-Edit_iddaw_cd
#BSUB -o /home/mima2416/repositories/PROVE/logs/train_gen_Qwen-Image-Edit_iddaw_cd_%J.out
#BSUB -e /home/mima2416/repositories/PROVE/logs/train_gen_Qwen-Image-Edit_iddaw_cd_%J.err
#BSUB -n 8
...
echo "========================================"
echo "Training job: gen_Qwen-Image-Edit on IDD-AW"
echo "Started: $(date)"
echo "========================================"
...
# Pre-flight checks
WEIGHTS_PATH="/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen-Image-Edit/iddaw_cd/deeplabv3plus_r50_ratio0p50"
...
# Pre-flight checks
WEIGHTS_PATH="/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen-Image-Edit/iddaw_cd/pspnet_r50_ratio0p50"
LOCK_FILE="${WEIGHTS_PATH}/.training_lock"
CHECKPOINT="${WEIGHTS_PATH}/iter_80000.pth"
...
# Pre-flight checks
WEIGHTS_PATH="/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen-Image-Edit/iddaw_cd/segformer_mit-b2_ratio0p50"
LOCK_FILE="${WEIGHTS_PATH}/.training_lock"
CHECKPOINT="${WEIGHTS_PATH}/iter_80000.pth"
