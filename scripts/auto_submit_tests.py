...
WEIGHTS_ROOTS = {
    '1': Path('/scratch/aaa_exchange/AWARE/WEIGHTS'),
    '2': Path('/scratch/aaa_exchange/AWARE/WEIGHTS_STAGE_2'),
    'cityscapes': Path('/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES'),
    'cityscapes-gen': Path('/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES_GEN'),
}
...
def submit_test_job(
    ...
    if test_type == 'acdc':
        ...
        extra_args = '--data-root /scratch/aaa_exchange/AWARE/FINAL_SPLITS --test-split test'
    else:
