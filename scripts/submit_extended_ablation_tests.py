...
WEIGHTS_S1 = Path('/scratch/aaa_exchange/AWARE/WEIGHTS')
WEIGHTS_CG = Path('/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES_GEN')
WEIGHTS_EXT = Path('/scratch/aaa_exchange/AWARE/WEIGHTS_EXTENDED_ABLATION')
