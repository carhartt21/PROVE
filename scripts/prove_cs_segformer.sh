...
#BSUB -q BatchGPU
#BSUB -o /scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3/train_%J.out
#BSUB -e /scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3/train_%J.err
#BSUB -n 8
...
mkdir -p /scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3
...
python unified_training.py \
    ...
    --eval-interval 2000 \
    --work-dir "/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3"
