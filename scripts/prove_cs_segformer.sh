...
#BSUB -q BatchGPU
#BSUB -o ${PROVE_ROOT}/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3/train_%J.out
#BSUB -e ${PROVE_ROOT}/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3/train_%J.err
#BSUB -n 8
...
mkdir -p ${PROVE_ROOT}/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3
...
python unified_training.py \
    ...
    --eval-interval 2000 \
    --work-dir "${PROVE_ROOT}/WEIGHTS_CITYSCAPES/baseline/cityscapes/segformer_mit-b3"
