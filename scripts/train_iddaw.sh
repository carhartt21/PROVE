#!/bin/bash
# PROVE Training Script: IDD-AW (India Driving Dataset - Adverse Weather)
# Dataset: /scratch/aaa_exchange/AWARE/FINAL_SPLITS/train/images/IDD-AW
