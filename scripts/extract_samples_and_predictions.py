...
OUTPUT_ROOT = Path('${PROVE_ROOT}/SAMPLE_EXTRACTION')
FINAL_SPLITS = Path('${PROVE_ROOT}/FINAL_SPLITS')
GENERATED_IMAGES = Path('${PROVE_ROOT}/GENERATED_IMAGES')
WEIGHTS_STAGE1 = Path('${PROVE_ROOT}/WEIGHTS')
WEIGHTS_STAGE2 = Path('${PROVE_ROOT}/WEIGHTS_STAGE_2')
