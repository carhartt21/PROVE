...
DEFAULT_DATA_ROOT="${PROVE_DATA_ROOT:-${PROVE_ROOT}/FINAL_SPLITS}"
DEFAULT_GEN_ROOT="${PROVE_GEN_ROOT:-${PROVE_ROOT}/GENERATED_IMAGES}"
DEFAULT_WEIGHTS_ROOT="${PROVE_WEIGHTS_ROOT:-${PROVE_ROOT}/WEIGHTS}"
