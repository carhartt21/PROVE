...
# Test model
if [ -f "/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50/iter_80000.pth" ]; then
    echo "Training complete. Running test..."
    python fine_grained_test.py \
        --weights_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50/iter_80000.pth \
        --config_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50/training_config.py \
        --dataset OUTSIDE15k \
        --output_dir /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50/test_results_detailed
else
    echo "ERROR: Training failed - checkpoint not found"
fi
...
# Test model
if [ -f "/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50_clear_day/iter_80000.pth" ]; then
    echo "Training complete. Running test..."
    python fine_grained_test.py \
        --weights_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50_clear_day/iter_80000.pth \
        --config_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50_clear_day/training_config.py \
        --dataset OUTSIDE15k \
        --output_dir /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/deeplabv3plus_r50_clear_day/test_results_detailed
else
    echo "ERROR: Training failed - checkpoint not found"
fi
...
# Test model
if [ -f "/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50/iter_80000.pth" ]; then
    echo "Training complete. Running test..."
    python fine_grained_test.py \
        --weights_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50/iter_80000.pth \
        --config_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50/training_config.py \
        --dataset OUTSIDE15k \
        --output_dir /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50/test_results_detailed
else
    echo "ERROR: Training failed - checkpoint not found"
fi
...
# Test model
if [ -f "/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50_clear_day/iter_80000.pth" ]; then
    echo "Training complete. Running test..."
    python fine_grained_test.py \
        --weights_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50_clear_day/iter_80000.pth \
        --config_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50_clear_day/training_config.py \
        --dataset OUTSIDE15k \
        --output_dir /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/pspnet_r50_clear_day/test_results_detailed
else
    echo "ERROR: Training failed - checkpoint not found"
fi
...
# Test model
if [ -f "/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5/iter_80000.pth" ]; then
    echo "Training complete. Running test..."
    python fine_grained_test.py \
        --weights_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5/iter_80000.pth \
        --config_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5/training_config.py \
        --dataset OUTSIDE15k \
        --output_dir /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5/test_results_detailed
else
    echo "ERROR: Training failed - checkpoint not found"
fi
...
# Test model
if [ -f "/scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5_clear_day/iter_80000.pth" ]; then
    echo "Training complete. Running test..."
    python fine_grained_test.py \
        --weights_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5_clear_day/iter_80000.pth \
        --config_path /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5_clear_day/training_config.py \
        --dataset OUTSIDE15k \
        --output_dir /scratch/aaa_exchange/AWARE/WEIGHTS/gen_Qwen_Image_Edit/outside15k/segformer_mit-b5_clear_day/test_results_detailed
else
    echo "ERROR: Training failed - checkpoint not found"
fi
