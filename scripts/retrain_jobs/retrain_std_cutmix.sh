#!/bin/bash
#BSUB -J retrain_std_cutmix
#BSUB -o /home/mima2416/repositories/PROVE/logs/retrain/retrain_std_cutmix_%J.out
#BSUB -e /home/mima2416/repositories/PROVE/logs/retrain/retrain_std_cutmix_%J.err
#BSUB -n 4
...
echo "========================================"
echo "Retraining job: retrain_std_cutmix"
echo "Strategy: std_cutmix"
echo "Started: $(date)"
echo "========================================"
...
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/deeplabv3plus_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/deeplabv3plus_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/deeplabv3plus_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/deeplabv3plus_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/pspnet_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/pspnet_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/pspnet_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/pspnet_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/segformer_mit-b5/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/segformer_mit-b5/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/segformer_mit-b5_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/bdd10k/segformer_mit-b5_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/deeplabv3plus_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/deeplabv3plus_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/deeplabv3plus_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/deeplabv3plus_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/pspnet_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/pspnet_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/pspnet_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/pspnet_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/segformer_mit-b5/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/segformer_mit-b5/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/segformer_mit-b5_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/idd-aw/segformer_mit-b5_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/deeplabv3plus_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/deeplabv3plus_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/deeplabv3plus_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/deeplabv3plus_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/pspnet_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/pspnet_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/pspnet_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/pspnet_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/segformer_mit-b5/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/segformer_mit-b5/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/segformer_mit-b5_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_cutmix/mapillaryvistas/segformer_mit-b5_clear_day/last_checkpoint 2>/dev/null
