...
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/deeplabv3plus_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/deeplabv3plus_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/deeplabv3plus_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/deeplabv3plus_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/pspnet_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/pspnet_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/pspnet_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/pspnet_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/segformer_mit-b5/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/segformer_mit-b5/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/segformer_mit-b5_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/bdd10k/segformer_mit-b5_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/deeplabv3plus_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/deeplabv3plus_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/deeplabv3plus_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/deeplabv3plus_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/pspnet_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/pspnet_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/pspnet_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/pspnet_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/segformer_mit-b5/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/segformer_mit-b5/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/segformer_mit-b5_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/idd-aw/segformer_mit-b5_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/deeplabv3plus_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/deeplabv3plus_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/deeplabv3plus_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/deeplabv3plus_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/pspnet_r50/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/pspnet_r50/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/pspnet_r50_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/pspnet_r50_clear_day/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/segformer_mit-b5/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/segformer_mit-b5/last_checkpoint 2>/dev/null
...
# Remove old checkpoints to force retraining
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/segformer_mit-b5_clear_day/iter_*.pth 2>/dev/null
rm -f /scratch/aaa_exchange/AWARE/WEIGHTS/std_randaugment/mapillaryvistas/segformer_mit-b5_clear_day/last_checkpoint 2>/dev/null
