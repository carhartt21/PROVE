#!/bin/bash
#BSUB -J prove_mapillary_aware
#BSUB -oo lsf_mapillary_aware_%J_gpu.log
#BSUB -eo lsf_mapillary_aware_%J_gpu.err
#BSUB -n 6
#BSUB -R "span[hosts=1]"
...
# PROVE LSF Training Script: MapillaryVistas (AWARE split)
...
echo "Host: ${LSB_HOSTS}"
echo "GPUs: 1"
echo "Dataset: MapillaryVistas (AWARE)"
echo "============================================"
