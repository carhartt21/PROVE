...
#BSUB -o /home/mima2416/repositories/PROVE/logs/combinations_batchgpu_fixed/train_gen_step1x_new_photometric_distort_bdd10k_segformer_mit-b5_ratio0p5_%J.out
#BSUB -e /home/mima2416/repositories/PROVE/logs/combinations_batchgpu_fixed/train_gen_step1x_new_photometric_distort_bdd10k_segformer_mit-b5_ratio0p5_%J.err
#BSUB -q BatchGPU
#BSUB -n 8
...
python unified_training.py \
    ...
    --domain-filter clear_day \
     \
    --work-dir "/scratch/aaa_exchange/AWARE/WEIGHTS_COMBINATIONS/gen_step1x_new+photometric_distort/bdd10k/segformer_mit-b5_ratio0p5" \
