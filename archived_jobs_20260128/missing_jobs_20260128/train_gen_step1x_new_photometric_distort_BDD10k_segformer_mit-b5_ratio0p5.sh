...
#BSUB -o /scratch/aaa_exchange/AWARE/WEIGHTS_COMBINATIONS/gen_step1x_new+photometric_distort/BDD10k/segformer_mit-b5_ratio0p5/train_%J.out
#BSUB -e /scratch/aaa_exchange/AWARE/WEIGHTS_COMBINATIONS/gen_step1x_new+photometric_distort/BDD10k/segformer_mit-b5_ratio0p5/train_%J.err
#BSUB -n 8
