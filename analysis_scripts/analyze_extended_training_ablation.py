...
EXTENDED_ROOT = Path('/scratch/aaa_exchange/AWARE/WEIGHTS_EXTENDED_ABLATION')
S1_WEIGHTS = Path('/scratch/aaa_exchange/AWARE/WEIGHTS')
CG_WEIGHTS = Path('/scratch/aaa_exchange/AWARE/WEIGHTS_CITYSCAPES_GEN')
